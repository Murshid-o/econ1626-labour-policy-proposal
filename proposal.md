...
```mermaid
graph TD
    A[AI Integration] --> B{Task Nature?}
    B -->|Routine Cognitive| C[High Automation Risk]
    B -->|Non-Routine/Social| D[High Augmentation Potential]
    C --> E[Wage Compression & Displacement]
    D --> F[Productivity Bonus & Wage Premium]
